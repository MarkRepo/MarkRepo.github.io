---
title: Spice Web Client详细设计文档
description: 基于开源项目flexVDI/spice_web_client,用h264和opus对音视频进行编码以优化音视频传输，解决flexVDI的各种交互bug
categoriess: avcodec
tags:
  - h264
  - opus
...
[github项目地址](https://github.com/MarkRepo/spice_web_client)
...
![web_client_framework.png](/assets/images/avencode/web_client_framework.png)
系统结构图
...
![h264_process.png](/assets/images/avencode/web_client_h264_video_stream_process.png)
视频处理流程图
...
![mse.png](/assets/images/avencode/web_client_mse.png) 
MSE原理图
...
![audio.png](/assets/images/avencode/web_client_audio_process.png)
音频处理流程图
...
![websockify.png](/assets/images/avencode/web_client_websockify.png)             
websocket代理启动脚本流程图
...
+ [虚拟桌面网页版实时音视频直播方案](https://markrepo.github.io/2018/07/09/webav-living/)